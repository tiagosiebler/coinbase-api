const { CBExchangeClient } = require('coinbase-api');
  ...
  // ENDPOINT: /products/volume-summary
  // METHOD: GET
  // PUBLIC: YES
  // Link to function: https://github.com/tiagosiebler/coinbase-api/blob/master/src/CBExchangeClient.ts#L603
...
client.getAllProductVolume(params)
  .then((response) => {
