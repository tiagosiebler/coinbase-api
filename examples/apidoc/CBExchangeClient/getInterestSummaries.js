const { CBExchangeClient } = require('coinbase-api');
  ...
  // ENDPOINT: /loans/interest
  // METHOD: GET
  // PUBLIC: NO
  // Link to function: https://github.com/tiagosiebler/coinbase-api/blob/master/src/CBExchangeClient.ts#L471
...
client.getInterestSummaries(params)
  .then((response) => {
