const { CBExchangeClient } = require('coinbase-api');
  ...
  // ENDPOINT: /loans/repay-principal
  // METHOD: POST
  // PUBLIC: NO
  // Link to function: https://github.com/tiagosiebler/coinbase-api/blob/master/src/CBExchangeClient.ts#L552
...
client.repayLoanPrincipal(params)
  .then((response) => {
