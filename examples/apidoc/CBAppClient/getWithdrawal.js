const { CBAppClient } = require('coinbase-api');
  ...
  // ENDPOINT: /v2/accounts/{account_id}/withdrawals/{withdrawal_id}
  // METHOD: GET
  // PUBLIC: NO
  // Link to function: https://github.com/tiagosiebler/coinbase-api/blob/master/src/CBAppClient.ts#L364
