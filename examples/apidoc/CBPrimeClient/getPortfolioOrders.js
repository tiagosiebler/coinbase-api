const { CBPrimeClient } = require('coinbase-api');
  ...
  // ENDPOINT: /v1/portfolios/{portfolio_id}/orders
  // METHOD: GET
  // PUBLIC: NO
  // Link to function: https://github.com/tiagosiebler/coinbase-api/blob/master/src/CBPrimeClient.ts#L420
...
client.getPortfolioOrders(params)
  .then((response) => {
