const { CBPrimeClient } = require('coinbase-api');
  ...
  // ENDPOINT: /v1/allocations
  // METHOD: POST
  // PUBLIC: NO
  // Link to function: https://github.com/tiagosiebler/coinbase-api/blob/master/src/CBPrimeClient.ts#L64
...
client.createPortfolioAllocations(params)
  .then((response) => {
