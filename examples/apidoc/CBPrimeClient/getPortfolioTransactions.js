const { CBPrimeClient } = require('coinbase-api');
  ...
  // ENDPOINT: /v1/portfolios/{portfolio_id}/transactions
  // METHOD: GET
  // PUBLIC: NO
  // Link to function: https://github.com/tiagosiebler/coinbase-api/blob/master/src/CBPrimeClient.ts#L493
...
client.getPortfolioTransactions(params)
  .then((response) => {
