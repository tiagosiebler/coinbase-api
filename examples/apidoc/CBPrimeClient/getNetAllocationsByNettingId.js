const { CBPrimeClient } = require('coinbase-api');
  ...
  // ENDPOINT: /v1/portfolios/{portfolio_id}/allocations/net/{netting_id}
  // METHOD: GET
  // PUBLIC: NO
  // Link to function: https://github.com/tiagosiebler/coinbase-api/blob/master/src/CBPrimeClient.ts#L113
...
client.getNetAllocationsByNettingId(params)
  .then((response) => {
