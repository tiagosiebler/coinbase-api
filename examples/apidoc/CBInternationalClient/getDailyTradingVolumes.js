const { CBInternationalClient } = require('coinbase-api');
  ...
  // ENDPOINT: /api/v1/instruments/volumes/daily
  // METHOD: GET
  // PUBLIC: YES
  // Link to function: https://github.com/tiagosiebler/coinbase-api/blob/master/src/CBInternationalClient.ts#L114
...
client.getDailyTradingVolumes(params)
  .then((response) => {
