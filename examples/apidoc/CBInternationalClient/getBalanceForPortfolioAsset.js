const { CBInternationalClient } = require('coinbase-api');
  ...
  // ENDPOINT: /api/v1/portfolios/{portfolio}/balances/{asset}
  // METHOD: GET
  // PUBLIC: NO
  // Link to function: https://github.com/tiagosiebler/coinbase-api/blob/master/src/CBInternationalClient.ts#L312
...
client.getBalanceForPortfolioAsset(params)
  .then((response) => {
